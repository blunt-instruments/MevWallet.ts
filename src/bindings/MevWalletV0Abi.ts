...
export interface MevWalletV0AbiInterface extends utils.Interface {
  functions: {
...
export interface MevWalletV0Abi extends BaseContract {
  contractName: "MevWalletV0Abi";

  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MevWalletV0AbiInterface;
